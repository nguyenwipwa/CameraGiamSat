            ...
            <div class="row">
                <div class="col-xs-12 col-md-9">
                    <div class="article_header my-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo e(url('/')); ?>">Trang chủ</a>
                            </li>
                            <li><a href="<?php echo e(route('news')); ?>">Tin camera</a>
                            </li>
                        </ol>
                    </div>
                    <div class="clear"></div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-4 full-right">
                                <div class="media-left">
                                    <a href="<?php echo e(route('news.detail', [$news->id])); ?>">
                                        <img class="media-object" alt="<?php echo e($news->title); ?>" src="<?php echo e(asset('public/images/tin-tuc/').'/'.$news->img); ?>">
                                    </a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-8 left-0">
                                <div class="media-body">
                                    <a href="<?php echo e(route('news.detail', [$news->id])); ?>">
                                        <h4 class="media-heading"><?php echo e($news->title); ?></h4>
                                    </a>
                                    <span class="media-date"> Lượt xem: <?php echo e($news->view_number); ?></span>
                                    <span class="media-desc"><?php echo e($news->decription); ?> <a href="<?php echo e(route('news.detail',[$news->id])); ?>" title="" style="background: #d36262;
                                    padding: 2px 10px;
                                    border-radius: 6px;
