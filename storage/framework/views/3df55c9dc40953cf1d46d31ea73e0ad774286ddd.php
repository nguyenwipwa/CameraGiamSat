      ...
      <div class="container-fluid">        <div class="row">
        ...
        <div class="col-md-9 col-md-pull-3 col-sm-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form action="<?php echo e(route('xoaall')); ?>" method="post" enctype="multipart/form-data" id="form-product">
                    ...
                    <tbody>
                     ...
                     <tr>
                      <td class="text-center">                  
                       <input type="checkbox" name="selected[]" value="<?php echo e($element->id); ?>">
                       ...
                       <td class="text-right">
                        <div style="min-width: 120px;">
                          <div class="btn-group"> <a href="<?php echo e(route('chitietdonhang',[$element->id])); ?>" data-toggle="tooltip" title="" class="btn btn-xprimary" data-original-title="Xem"><i class="fa fa-eye"></i>
                          </a>
                          <button type="button" data-toggle="dropdown" class="btn btn-primary dropdown-toggle"><span class="caret"></span></button>
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href=""><i class="fa fa-pencil"></i> Sửa</a></li>
                            <li><a href="<?php echo e(route('xoadonhangspam',[$element->id])); ?>"><i class="fa fa-trash-o"></i> Xoá</a></li>
                          </ul>
                        </div>
                      </div>
                    </td>
