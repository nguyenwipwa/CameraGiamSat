                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <ul class="nav nav-tabs custom-tabs " role="tablist">
                                <li role="presentation" class="active"><a href="http://fptcamera.vn/camera-giam-sat"><?php echo e($cate->name); ?></a></li>
                                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <?php if($cate->id == $cate1->id_root && $cate1->status==1): ?>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="dmsp-camera-giam-sat">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 hidden-xs hidden-sm hidden-md">
                                            <a class="b_a2" href="http://fptcamera.vn/camera-khong-day"><img alt="lap-camera-giam-sat-khong-day-wifi" src="http://fptcamera.vn/resources/uploads/images/automatic/quang-cao/<?php echo e($slide[0]->img); ?>"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
