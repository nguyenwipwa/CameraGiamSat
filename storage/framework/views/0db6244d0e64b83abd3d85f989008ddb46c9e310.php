...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('public/css/classic.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('public/css/style.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('public/css/quangcao.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('public/css/modal.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('public/css/re.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('public/css/style.css')); ?>">
  <link rel="stylesheet"  type="text/css" href="<?php echo e(asset('public/css/hover-min.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/themsp.css')); ?>">
  ...
  <script src="<?php echo e(asset('public/js/classic.js')); ?>"></script>
  <script src="<?php echo e(asset('public/js/jquery.validate.js')); ?>"></script>
  <script src="<?php echo e(asset('public/js/additional-methods.js')); ?>"></script>
  <script src="<?php echo e(asset('public/danhsachsanpham.js')); ?>"></script>
...
<body>
  ...
  <?php echo $__env->make('SliderHeader', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="container row " style="border: 1px solid #ddd; padding-left: 0px;padding-left: 0px;">
    ...
    <div id="content" class="col-md-9">
      ...
      <!-- boxSearch -->
      <?php echo $__env->make('index.boxsearch', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

      <?php echo $__env->make('index.tabContaint', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<!-- <div class="tintuc"  style="float: left;"> -->
  <!-- <?php echo $__env->make('index.news', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
  <!-- </div> -->
</div>
</div>
