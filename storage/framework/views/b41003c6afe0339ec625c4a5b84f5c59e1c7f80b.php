						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form action="http://localhost/opencart/admin/index.php?route=news/news/delete&amp;user_token=J4lAsHL9NSBlFhVdZ63ZhssBvr5tmXr0" method="post" enctype="multipart/form-data" id="form-news">
									<div class="table-responsive">
										<table class="table table-bordered table-hover">
											...
											<tbody>
												<?php $__currentLoopData = $listNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>
													<td class="text-center">                                                        <input type="checkbox" name="selected[]" value="1">
													</td>
													<td class="text-center"> <img style="width: 50px;height: 50px;" src="<?php echo e(asset('public/images/tin-tuc/'.$row->img)); ?>" alt="" class="img-thumbnail"> </td>
													<td class="text-left"><?php echo e($row->title); ?></td>
													<td class="text-left"><?php echo e($row->status==1?'Kích hoạt' : 'Chưa kích hoạt'); ?> <?php echo e($row->id); ?></td>
													<td class="text-right"><a href="<?php echo e(route('suatintuc1',['id' => $row->id])); ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Sửa"><i class="fa fa-pencil"></i></a></td>
												</tr>
								...
								<div class="row">
									...
									<div class="col-sm-6 text-right"><?php echo e($listNews->render()); ?></div>
								</div>
							</div>
						</div>
					</div>
