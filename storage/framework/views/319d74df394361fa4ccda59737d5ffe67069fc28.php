      ...
      <div class="page-header">
        <div class="container-fluid">
          <div class="pull-right">
            ...
            <a href="<?php echo e(url('/admin/themsanpham.html')); ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Thêm"><i class="fa fa-plus"></i></a>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right"><a href="<?php echo e(url('/admin/suasanpham.html/'.$row->id)); ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Sửa"><i class="fa fa-pencil"></i></a></td>
                      </tr>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 text-left">Hiển thị từ <?php echo e($listProduct->currentPage()); ?> đến   <?php echo e($listProduct->lastPage()); ?> trang </div>
                <div class="col-sm-6 text-right"><?php echo e($listProduct->render()); ?></div>
              </div>
            </div>
          </div>
        </div>
