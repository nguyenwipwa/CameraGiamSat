...
<body>
    ...
    <script src="<?php echo e(asset('public/admin/js/tkspbanchay.js')); ?>"></script>
 <script src="<?php echo e(asset('public/admin/js/Chart.min.js')); ?>"></script>
 <script src="<?php echo e(asset('public/admin/js/Chart.bundle.js')); ?>"></script>
