				...
				<div class="container-fluid">         
					<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo e(route('suatintuc',['id'=>$news->id])); ?>" method="POST" enctype="multipart/form-data" id="form-news" class="form-horizontal">
                                      ...
                                      <div class="tab-content">                                   
                                         <div class="tab-pane active" id="language2">
                                            <div class="form-group required">
                                              ...
                                              <div class="col-sm-10">
                                                <input type="text" name="title" value="<?php echo e($news->title); ?>" required="true" placeholder="Tên tin tức" id="input-name2" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                           <label class="col-sm-2 control-label" for="input-description2">Nội dung</label>
                                           <div class="col-sm-10">
                                              <textarea name="content" placeholder="Mô tả" id="input-description2" data-toggle="summernote" data-lang="" class="form-control" style="display: none;"><?php echo e($news_descrip->content); ?></textarea>
                                          </div>	
                                      </div>
                                      <div class="form-group required">
                                         <label class="col-sm-2 control-label" for="input-meta-title2">Mô tả</label>
                                         <div class="col-sm-10">
                                            <textarea name="description" rows="5" placeholder="Thẻ meta Mô tả" id="input-meta-description2" class="form-control"><?php echo e($news->decription); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="col-sm-2 control-label" for="input-meta-description2">Hình ảnh</label>
                                       <div class="col-sm-10">
                                          <input type="file" name="fImage" rows="5" value="<?php echo e($news->img); ?>" placeholder="" id="" class="form-control"></input>
                                      </div>
                                  </div>
