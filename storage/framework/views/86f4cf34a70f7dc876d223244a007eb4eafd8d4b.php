...
<br>
<form method="post" action="<?php echo e(route('loginUser')); ?>" name="fLogin" id="fLogin" onsubmit="return checkLog(this)">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2" class="tbl_from">
		...
		<tr>
			<td></td>
			<td><input type="checkbox" name="ch_remember" id="ch_remember" value="1" checked="checked">&nbsp; <span class="font_err">Ghi nhớ đăng nhập</span> | <a href="<?php echo e(route('password.request')); ?>"><b>Bạn quên mật khẩu ?</b></a></td>
		</tr>
		<tr>
			<td></td>
