					...
					<div class="form_label_input"><label style="font-weight:bold" for="address">Địa chỉ <span class="required"> * </span></label>
						...
						<div class="form_label_input"><label style="font-weight:bold" for="address">Thành phố <span class="required"> * </span></label>
							...
							<td style="vertical-align:top">
								...
								<table id="cart" class="inside">
									<tbody>
										...
										<tr>
											...
											<td class="text_right" colspan="2">
												<span id="tongtien" class="tongtien" style="display:block;color:red;font-weight:bold;"><?php echo e(Cart::total()); ?> VNĐ (<?php echo e(Cart::total1()*0.000044); ?>$)</span>
											</td>
										</tr>
								...
								<a id="apaypal" href="javascript::void(0)" onclick="openRequestedPopup('<?php echo e(url('gio-hang/paypal')); ?>/MDH_<?php echo e(time()); ?>/<?php echo e(Cart::total1()*0.000044); ?>')">
