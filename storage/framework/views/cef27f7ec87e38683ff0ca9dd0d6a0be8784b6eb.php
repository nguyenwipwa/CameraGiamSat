			...
			<div class="row">
				<div class="col-xs-12 col-md-9">
					<div class="article_header my-breadcrumb">
						<ol class="breadcrumb"><li><a href="<?php echo e(url('/')); ?>">Trang chủ</a></li><li><a href="<?php echo e(route('news')); ?>">Tin camera</a></li></ol>
					</div>
					<div class="clear"></div>
					<div style="padding:10px;background:#fff;border:1px solid #eee;border-radius:3px;">
						<h1 class="header2">
							<?php echo e($newsDetail->title); ?>                                  </h1>
							<div class="news-view">
								<div class="row">
									<div class="col-xs-12">Lượt xem: <?php echo e($newsDetail->view_number); ?></div>
									<div class="col-xs-12">
							...
							<div class="clear"></div>
							<div class="news-desc"><?php echo e($newsDetail->decription); ?></div>
							<?php echo html_entity_decode($newsDetail->content); ?>
