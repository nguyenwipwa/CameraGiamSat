...
<body>
	<form id="payform" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
		...
		<input id="pricePaypal" style="display: none;" class="hidden" type="number" name="amount" placeholder="Nhập số tiền vào" value="<?php echo e($total); ?>">
		<!--Loại tiền-->
		<input type="hidden" name="currency_code" value="USD">

		<!--Đường link mình cung cấp cho Paypal biết để sau khi xử lí thành công nó sẽ chuyển về theo đường link này-->
		<input type="hidden" name="return" value="<?php echo e(route('paypal.success')); ?>">
