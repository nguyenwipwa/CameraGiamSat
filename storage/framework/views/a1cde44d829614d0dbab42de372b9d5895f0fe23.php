...
<head>
   ...
   <script src=" <?php echo e(asset('public/admin/js/danhsachhoadon.js')); ?>" type="text/javascript"></script>
   <script src=" <?php echo e(asset('public/admin/js/functionhoadon.js')); ?>" type="text/javascript"></script>
    <script src=" <?php echo e(asset('public/admin/js/jquery.quicksearch.js')); ?>"></script>
    <link rel="stylesheet" type="text/css" href=" <?php echo e(asset('public/admin/css/hoadon.css')); ?>">
