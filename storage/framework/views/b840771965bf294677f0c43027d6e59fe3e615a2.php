                            ...
                            <div id="social_us">
                                ...
                                <div id="f_social">
                                    <a target="_blank" rel="nofollow" href="https://www.facebook.com/FptCamera.vn">
                                        <img src="<?php echo e(asset('public/images/ui_images/f_fb.png')); ?>">
                                    </a>
                                    <a target="_blank" rel="nofollow" href="https://plus.google.com//+FptCamera">
                                        <img src="<?php echo e(asset('public/images/ui_images/f_gplus.png')); ?>">
                                    </a>
                                    <a target="_blank" rel="nofollow" href="https://www.youtube.com/c/FptCamera">
                                        <img src="<?php echo e(asset('public/images/ui_images/f_yt.png')); ?>">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="social-claim2">
                            ...
                            <div style="margin:10px;">
                                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            <td><img alt="" src="<?php echo e(asset('public/images/ui_images/tro-giup.png')); ?>" style="width: 68px; height: 81px;" /></td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <hr /><span style="color:#555555;"><span style="font-size:13px;"><img alt="" src="<?php echo e(asset('public/images/ui_images/life_saver.png')); ?>life_saver.png" />&nbsp; Chăm sóc và hỗ trợ sau bán hàng</span></span>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tr>
                                        <td colspan="2"><span style="font-size:13px;"><span style="color:#555555;"><img alt="" src="<?php echo e(asset('public/images/ui_images/mailer.png')); ?>" />&nbsp; fptcamera.vn@gmail.com</span></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
