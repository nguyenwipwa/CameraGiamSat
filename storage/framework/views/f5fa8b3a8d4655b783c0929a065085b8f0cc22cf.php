                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-5">
                                    ...
                                    <div class="prd-desc equalheight1">
                                        ...
                                        <p>Thương hiệu: <a href="http://fptcamera.vn/benco-viet-nam"><?php echo e($product->name); ?></a>
                                        </p>
                            ...
                            <div class="hidden-xs">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="chitiet">
                                            <?php echo $product->detail_product; ?>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-4">
                                    <div class="thumbnail products">
                                        <a href="http://fptcamera.vn/dau-ghi-hinh-benco-4-kenh-ben-xvr1104c-full-hd"><img alt="Đầu ghi hình BENCO 4 kênh BEN-XVR1104C FUll HD" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/dau-ghi-hinh-benco-4-kenh-BEN-XVR1104C.jpg">
                                        </a>
                                        <div class="caption"> <a href="http://fptcamera.vn/dau-ghi-hinh-benco-4-kenh-ben-xvr1104c-full-hd"><h3>Đầu ghi hình BENCO 4 kênh BEN-XVR1104C FUll HD</h3></a>
                                            <div class="clear"></div>
                                            <div class="row">
                                                <div class="col-xs-12"><span class="new-price">1.350.000 đ</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-6 col-sm-4">
                                    <div class="thumbnail products">
                                        <a href="http://fptcamera.vn/camera-benco-ben-cvi-1120bp"><img alt="Camera Benco BEN-CVI 1120BP" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/camera-benco-1120BP.jpg">
                                        </a>
                                        <div class="caption"> <a href="http://fptcamera.vn/camera-benco-ben-cvi-1120bp"><h3>Camera Benco BEN-CVI 1120BP</h3></a>
                                            <div class="clear"></div>
                                            <div class="row">
                                                <div class="col-xs-12"><span class="new-price">464.000 đ</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-6 col-sm-4">
                                    <div class="thumbnail products">
                                        <a href="http://fptcamera.vn/camera-benco-ben-cvi-1120dp"><img alt="Camera Benco BEN-CVI 1120DP" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/camera-benco-1120DP.jpg">
                                        </a>
                                        <div class="caption"> <a href="http://fptcamera.vn/camera-benco-ben-cvi-1120dp"><h3>Camera Benco BEN-CVI 1120DP</h3></a>
                                            <div class="clear"></div>
                                            <div class="row">
                                                <div class="col-xs-12"><span class="new-price">464.000 đ</span>
                                                </div>
                        ...
                        <div class="col-xs-12 col-md-3"> <span class="header3">Sản phẩm cùng danh mục</span>
                            <div class="media products">
                                <div class="media-left">
                                    <a href="http://fptcamera.vn/camera-full-hd-cho-nha-biet-thu-dep"> <img class="media-object" alt="Camera Full HD Cho Nhà Biệt Thự Đẹp" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/tron-goi-camera-gia-dinh1.jpg"> </a>
                                </div>
                                <div class="media-body">
                                    <a href="http://fptcamera.vn/camera-full-hd-cho-nha-biet-thu-dep">
                                        <h4 class="media-heading">Camera Full HD Cho Nhà Biệt Thự Đẹp</h4> </a> <span class="media-price">3.666.670 đ</span> </div>
                            </div>
                            <div class="media products">
                                <div class="media-left">
                                    <a href="http://fptcamera.vn/lap-2-camera-hikvision"> <img class="media-object" alt="lap-2-camera-hikvision" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/lap-2-camera-hikvision.jpg"> </a>
                                </div>
                                <div class="media-body">
                                    <a href="http://fptcamera.vn/lap-2-camera-hikvision">
                                        <h4 class="media-heading">Lắp 2 Camera HIKVISION</h4> </a> <span class="media-price">4.299.000 đ</span> </div>
                            </div>
                            <div class="media products">
                                <div class="media-left">
                                    <a href="http://fptcamera.vn/lap-dat-1-camera-hikvision"> <img class="media-object" alt="tron-bo-1-camera-hd-tvi-hikvision" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/tron-bo-1-camera-hd-tvi-hikvision.jpg"> </a>
                                </div>
                                <div class="media-body">
                                    <a href="http://fptcamera.vn/lap-dat-1-camera-hikvision">
                                        <h4 class="media-heading">Lắp đặt 1 camera HIKVISION</h4> </a> <span class="media-price">2.999.000 đ</span> </div>
                            </div>
                            <div class="media products">
                                <div class="media-left">
                                    <a href="http://fptcamera.vn/lap-dat-camera-gia-re"> <img class="media-object" alt="lap-dat-camera-gia-re-ha-noi" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/lap-dat-camera-gia-re-ha-noi.jpg"> </a>
                                </div>
                                <div class="media-body">
                                    <a href="http://fptcamera.vn/lap-dat-camera-gia-re">
                                        <h4 class="media-heading">Lắp đặt camera giá rẻ</h4> </a> <span class="media-price">2.199.000 đ</span> </div>
                            </div>
                            <div class="media products">
                                <div class="media-left">
                                    <a href="http://fptcamera.vn/lap-dat-tron-bo-3-camera-gia-re"> <img class="media-object" alt="Lắp Đặt Trọn Bộ 3 Camera Giá Rẻ" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/lap-dat-tron-bo-3-camera-gia-re1.jpg"> </a>
                                </div>
                                <div class="media-body">
                                    <a href="http://fptcamera.vn/lap-dat-tron-bo-3-camera-gia-re">
                                        <h4 class="media-heading">Lắp Đặt Trọn Bộ 3 Camera Giá Rẻ</h4> </a> <span class="media-price">4.199.000 đ</span> </div>
                            </div>
                            <div class="media products">
                                <div class="media-left">
                                    <a href="http://fptcamera.vn/tron-bo-camera-kce-nhap-khau-han-quoc"> <img class="media-object" alt="Trọn bộ Camera KEC nhập khẩu HÀN QUỐC" src="http://fptcamera.vn/resources/uploads/images/automatic/san-pham/tron-bo-camera-kec-han-quoc.jpg"> </a>
                                </div>
                                <div class="media-body">
                                    <a href="http://fptcamera.vn/tron-bo-camera-kce-nhap-khau-han-quoc">
                                        <h4 class="media-heading">Trọn bộ Camera KCE nhập khẩu HÀN QUỐC</h4> </a> <span class="media-price">8.500.000 đ</span> </div>
                            </div>
                        </div>
                    </div>
                </div>
