                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a type="submit" href= "<?php echo e(route('suaUser', ['user'=> $u->id])); ?>" class="btn btn-success btn-edit" data-toggle="modal" data-target="#myModal1"><i class="fa fa-eye" ></i> 
                      </a> 
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" >
      <input type="radio" name="active1" value="0" 
      <?php if($u->active ==0): ?>
      <?php echo e("checked"); ?>

      <?php endif; ?>
      >Chưa kích hoạt<br>
      <input type="radio" name="active1" value="1" 
      <?php if($u->active ==1): ?>
      <?php echo e("checked"); ?>
