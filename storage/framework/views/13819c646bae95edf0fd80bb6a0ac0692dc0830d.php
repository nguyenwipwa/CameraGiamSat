...
<head>
 ...
 <?php echo $__env->make('admin.link', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <script src="<?php echo e(asset('public/admin/js/danhsachmenu.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('public/admin/js/functionmenu.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('public/admin/js/jquery.quicksearch.js')); ?>" type="text/javascript"></script>
        <link href="<?php echo e(asset('public/admin/css/danhsachmenu.css')); ?>" rel="stylesheet" type="text/css" />
</head>
<body>
