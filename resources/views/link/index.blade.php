    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/font-awesome-4.7.0/css/font-awesome.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{asset('public/stylesheets/flexslider.css')}}" />
    ...
    <script type="text/javascript">
        function lookup(keyword) {
            ...
            if (keyword.length == 0) {
                ...
                $.get("{{url('/search-ajax')}}/"+ keyword, null ,
                    function(data) {
                        if (data.length > 14) {
