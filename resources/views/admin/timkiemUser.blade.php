    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <section class="content-header">
          <h1>
            KẾT QUẢ TÌM KIẾM: {{count($tukhoa)}} kết quả
...
?>
                              <tr>
                                    @foreach($usertk as $u)
                                  <td>{{$u->id}}</td>
                                  <td>{!! doimau($u->name,$tukhoa) !!}</td>
                                  <td>{!! doimau($u->email,$tukhoa) !!}</td>      
                                  <td>{!! doimau($u->phone_number,$tukhoa) !!}</td>    
                                  <td>
                                    @if($u->active == 1)
                                    {{"Đã kích hoạt"}}
                                    @else
                  ...
                  <a type="submit" href= "{{route('suaUser', ['user'=> $u->id])}}" class="btn btn-success btn-" data-toggle="modal" data-target="#myModal1"><i class="fa fa-eye" ></i> 
                    </a> 
