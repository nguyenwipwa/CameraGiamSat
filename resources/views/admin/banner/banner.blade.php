              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-right"><a href="{{ route('add.banner', ['center']) }}" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Sửa"><i class="fa fa-pencil"></i></a></td>
                  </tr>
                    <tr>
                    <td class="text-center">                    
                      <input type="checkbox" name="selected[]" value="">
                    ...
                    <td class="text-left">Kích hoạt</td>
                    <td class="text-right"><a href="{{ route('add.banner', ['right']) }}" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Sửa"><i class="fa fa-pencil"></i></a></td>
                  </tr>
                </tbody>
              </table>
            </div>
