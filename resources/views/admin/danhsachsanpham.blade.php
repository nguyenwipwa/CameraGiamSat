                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"> <img src="{{ asset('public/images/san-pham/'.$row->img) }}" alt="Sony VAIO" class="img-thumbnail" style="width: 50px;height: 50px;"> </td>
                        <td class="text-left">{{ $row->name }}</td>
                        <td class="text-left">SP{{ $row->id }}</td>
                        <td class="text-right">                     {{ number_format($row->price)}} đ
                        </td>
