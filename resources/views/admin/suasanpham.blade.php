        ...
        <div class="container-fluid">
          <div class="pull-right">
            ...
            <ul class="breadcrumb">
              ...
              <li><a href="{{ route('danhsachsanpham') }}">Quản lý sản phẩm</a></li>
            </ul>
          </div>
        </div>
        <div class="container-fluid">  
                  ...
                  <div class="tab-content">               
                   <div class="tab-pane active" id="language2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input style="cursor: pointer;" value="{{ $product->img }}" class="form-control" readonly="readonly" name="icon" id="img" onclick="$('#file').click()">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="status" id="input-status" class="form-control">
                      ...
                      <option value="0" {{$product->status!=1 ? "selected" : " "}}>Vô hiệu hóa</option>
