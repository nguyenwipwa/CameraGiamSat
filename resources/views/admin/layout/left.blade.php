  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{ route('danhsachdonhang') }}"><i class="fa fa-circle-o"></i> Quản lý hóa đơn</a></li>
          <li><a href="{{ route('donhangspam') }}"><i class="fa fa-circle-o"></i> Đơn hàng spam</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('danhsachUser') }}"><i class="fa fa-circle-o"></i> Thành viên</a></li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('phieugiamgia') }}"><i class="fa fa-circle-o"></i> Phiếu giảm giá </a></li>
               </ul>
             </li>
             <li class="treeview" >
              <a href="#m2">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('quanlytintuc') }}"><i class="fa fa-circle-o"></i> Tin tức sự kiện</a></li>
